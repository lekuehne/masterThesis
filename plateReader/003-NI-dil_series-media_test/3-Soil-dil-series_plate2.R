...
# write to CSV
write.csv(combined_data, "all_data_plate2.csv", row.names = FALSE)
...
summary_stat %>% 
  ...
  geom_errorbar(
    ...
    width = 0.5 ) +
  theme_classic() +
  labs(y="OD 600", x="Time", title = "OD 600 of Soil Sample 3 (LB)")
...
summary_stat %>% 
  ...
  geom_errorbar(
    ...
    width = 0.5 ) +
  theme_classic() +
  labs(y="OD 600", x="Time", title = "OD 600 of Soil Sample 4 (LB)")
