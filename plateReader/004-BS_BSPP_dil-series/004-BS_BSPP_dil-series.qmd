...
## First timeset 
OD <- read_excel("004-BS_BSPP_dil-series_20260408_151627.xlsx", range = "B122:CU146", col_names = TRUE)  
G <- read_excel("004-BS_BSPP_dil-series_20260408_151627.xlsx", range = "B176:CU200", col_names = TRUE) # GFP70
R <- read_excel("004-BS_BSPP_dil-series_20260408_151627.xlsx", range = "B203:CU227", col_names = TRUE) # RFP90

## Second timeset
OD2 <- read_excel("004-BS_BSPP_dil-series_20260409_130939.xlsx", range = "B122:CU144", col_names = TRUE)  
G2 <- read_excel("004-BS_BSPP_dil-series_20260409_130939.xlsx", range = "B172:CU194", col_names = TRUE) # GFP70
R2 <- read_excel("004-BS_BSPP_dil-series_20260409_130939.xlsx", range = "B197:CU219", col_names = TRUE) # RFP90
...
## Third timeset
OD3 <- read_excel("004-BS_BSPP_dil-series_20260410_120536.xlsx", range = "B122:CU141", col_names = TRUE)
G3 <- read_excel("004-BS_BSPP_dil-series_20260410_120536.xlsx", range = "B166:CU185", col_names = TRUE) # GFP70
R3 <- read_excel("004-BS_BSPP_dil-series_20260410_120536.xlsx", range = "B188:CU207", col_names = TRUE) # RFP90
...
## OD all, facet
```{r}
#| label: 004-BS_BSPP_dil-series.facet
...
OD.all <- ggplot(summary_df, aes(
  ...
  labs(y= expression("OD"[600]), x="Time [h]", title = "OD<sub>600</sub> of <i>P. putida</i> (A) and <i>B. subtilis</i> (B) for a serial dilution of <i>B.s.</i> starting densities") + 
  facet_wrap(~ species)
